...
import com.digisinage.realmdatabase.model.SocialAccount;
import com.digisinage.realmdatabase.model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void addUserToRealm_Synchronously(View view) {
        ...
        // this generates random and unique key
...
//		}
        ...
        myRealm.executeTransaction(new Realm.Transaction() {
            ...
            public void execute(Realm realm) {
                ...
                // remember to pass primary key as parameter to this method
    ...
    protected void onStop() {
        super.onStop();
        // if the user switches to another app, then we cancel the transaction
